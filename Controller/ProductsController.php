...
if (!empty($_SESSION['id'])) {
    if (isset($_POST['addProduct'])) {
        ...
        $user_fld = array('user_id', 'date_created');
        $user_val = array($_SESSION['id'], $date);
        ...
        deleteProduct('products', array('id', 'user_id'), array($product_id, $_SESSION['id']));
...
>>>>>>> d1a4a0edd6496104a7f8ef2a27a0b7273a4c4e1b
