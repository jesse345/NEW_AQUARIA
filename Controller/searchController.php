    ...
    if(isset($_POST['key'])){
       # database connection file
        ...
        <li class="p-2 border-bottom mb-1" style="background-color: #eee;">
            <a href="chat.php?user=<?php echo $user['user_id']?>" class="d-flex justify-content-between" name="view_messages">
                <div class="d-flex flex-row">
                    ...
                    <div class="pt-1">
                        ...
                        <p class="fw-bold mb-0"><?php echo $user['first_name'].' '.$user['last_name'] ?></p>
