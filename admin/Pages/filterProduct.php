...
if (isset($_GET['search'])) {
    ...
    $fishes = getProductByCategory('Fishes');
    $rec = array();
    while ($fish = mysqli_fetch_assoc($fishes)) {

        array_push($rec, $fish['product_id']);
    }
}
        ...
        <div class="container-fluid mt-5">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <div class="d-flex">
                        <div class="mr-auto">
                            <h6 class="m-0 font-weight-bold text-primary">Filter Product</h6>
                        </div>
                        <div class="ml-auto">
                            <form action="#">
                        ...
                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0" style="text-align:center;">
                            ...
                            if (count($rec) > 0) {
                                for ($i = 0; $i < count($rec); $i++) {
                                    ...
                                    $row = mysqli_fetch_assoc(getProduct('product_details', 'product_id', $rec[$i]));
                            ?>
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <?php if (empty($row['filter'])) { ?>
                                                    <form action="../Controller/productController.php?product_id=<?php echo $row['product_id']; ?>" method="POST">
                                                        <input type="submit" value="Collector" class="btn btn-primary" style="width: 100px" name="collector">
                                                        <input type="submit" value="Newbie" class="btn btn-secondary mt-2" style="width: 100px" name="newbie">
                                                    </form>
                                                    <?php } else {
                                                    if ($row['filter'] == 1) {
                                                    ?>

                                                        <p class="text-primary"> Collector </p>

                                                    <?php } else { ?>
                                                        <p class="text-secondary"> Newbie </p>
